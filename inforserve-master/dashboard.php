...
include('includes/dbconnection.php');
	...
	$usersquery = "SELECT COUNT(*) FROM tbluser where Username!='Admin'";
		...
		<div class="main-content">
			...
			<div class="main">
				...
				<div class="widget" style="background-color:   #F2353C">
					<div class="title" style="background-color:  #E62020;color: #fff">Number of Registered Hospitals</div>
				...
				<div class="widget" style="background-color:  #247CF0">
					<div class="title" style="background-color: #0B69E3; color: #fff">Number of Registered Doctors</div>
